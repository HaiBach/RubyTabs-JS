...
var RubyDOM = /** @class */ (function () {
    ...
    function RubyDOM(selector) {
        ...
        if (!!selector && selector.nodeType) {
            ...
            // Collection Node DOM
            var $items = RubyM.IsArray(selector) ? selector : RubyM.IsString(selector)
    ...
    RubyDOM.prototype.addClass = function (str) {
        var arrStr = RubyM.RemoveWhiteSpace(str).split(' '), strClass = this.attr('class'), arrClass = RubyM.RemoveWhiteSpace(strClass).split(' '), isChange = false;
        for (var i = 0, len = arrStr.length; i < len; i++) {
            var valueCur = arrStr[i], index = arrClass.indexOf(valueCur);
    ...
    // Search Children
    RubyDOM.prototype.children = function (str) {
        var $childs1 = [];
        var $childs2 = [];
