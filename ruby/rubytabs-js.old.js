...
(function () {
    ...
    var M = /** @class */ (function () {
        ...
        M.RemoveWhiteSpace = function (str) {
        ...
        M.RandomInArray = function (arr, except) {
            ...
            if (M.IsArray(arr)) {
                 ...
                 */
                var itemCur = M.Assign([], arr), indexItemLast = $.inArray(except, itemCur);
    ...
    var RubyDOM = /** @class */ (function () {
        ...
        RubyDOM.prototype.addClass = function (str) {
            var arrStr = M.RemoveWhiteSpace(str).split(' '), strClass = this.attr('class'), arrClass = M.RemoveWhiteSpace(strClass).split(' '), isChange = false;
        ...
        // Search Childrent
        RubyDOM.prototype.childrent = function (str) {
            var $items = this.item;
        };
        return RubyDOM;
    }());
    ...
    var FnRubyTabs = function ($ruby, OptsJS) {
        ...
        PROP = {
            ...
            MergeAllModules: function () {
                ...
                API = M.Assign(API, rt01MODULE.APIMORE);
                VIEW = M.Assign(VIEW, rt01MODULE.VIEWMATH, rt01MODULE.VIEWCSS, rt01MODULE.VIEWCOVERFLOW3D, one);
            ...
            MergeAllOpts: function () {
                ...
                if (!is.tf)
                    o = M.Assign(o, o.fallback);
                if (is.mobile)
                    o = M.Assign(o, o.mobile);
                else
                    o = M.Assign(o, o.desktop);
            },
            /**
            ...
            Pagination: function () {
                ...
                if (M.IsNumber(op.width) || M.IsNumber(op.height))
            ...
            Slides: function () {
                ...
                va.$s.each(function (i) {
                    var $slCur = $(this), slData = M2.Data($slCur), optsCur = slData['opts'] || {};
                    /**
                     * SETUP REQUIRED PART
        ...
        UPDATE = {
             ...
             */
            CanvasMask: function () {
                var isMaskCur = M2.Data(cs.idCur)['opts']['isMask'], classMask = va.ns + 'mask';
                /**
                 * CASE: MASK AUTO
                 */
                if (isMaskCur == 'auto') {
        ...
        RENDER = {
            ...
            Slide: function ($sl) {
                ...
                if (/^(div|li|article|section)$/.test(slTagBegin) || $sl.hasClass(slClass)) {
                    ...
                    var canvasTag = M2.Data($canvas)['tagName'], slTag = (canvasTag == 'ul') ? '<li/>' : divdiv, $wrapper = $(slTag, { 'class': slClass });
                    $sl.wrap($wrapper);
            ...
            CapPagHTML: function ($slCur) {
                 ...
                 */
                var ns = va.ns, capHTML = '', slData = M2.Data($slCur), $imgback = $slCur.find('.' + ns + o.nameImageBack);
        ...
        LOAD = {
            ...
            SlideEnd: function ($slide) {
                var hSlide = M.OuterHeight($slide, true), slData = M2.Data($slide), id = slData.id, ns = va.ns;
        ...
        POSITION = {
            ...
            AnimRebound: function (dirs) {
                ...
                if (is.tf)
                    xCur = (xCur == 'none') ? xBack : M2.ValueX(xCur);
                else
            ...
            CheckMobileTap: function ($items) {
                $items.each(function () {
                    ...
                    $item.on(va.ev.swipe.start, function (e) {
                        var itemData = M2.Data($(this)), i = EVENTS.GetEventRight(e);
...
//# sourceMappingURL=rubytabs-js.old.js.map