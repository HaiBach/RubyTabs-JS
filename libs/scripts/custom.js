...
var RENDER = {
  ...
  Header : function() {
    ...
    '<div class="wrapper header logo-left"><div class="container">' +
      '<!-- Logo -->' +
      '<a class="logo" href="../templates/" data-mScale="100">RubyTabs</a>' +
      ...
      '<ul class="rm01menu">' +
        ...
        '<li><a href="https://codecanyon.net/item/ruby-tabs-premium-tabs-slider/14156443?ref=haibach">Buy now!</a></li>' +
      '</ul>' +
      '</nav>' +
